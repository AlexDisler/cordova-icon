...
var getPlatforms = function (projectName) {
  ...
  platforms.push({
    ...
    icons : [
      { dest: 'icon-20.png',              size: 20   },
      { dest: 'icon-20@2x.png',           size: 40   },
      { dest: 'icon-20@3x.png',           size: 60   },
      { dest: 'icon-40.png',              size: 40   },
      { dest: 'icon-50.png',              size: 50   },
      { dest: 'icon-50@2x.png',           size: 100  },
      { dest: 'icon-60@2x.png',           size: 120  },
      { dest: 'icon-60@3x.png',           size: 180  },
      { dest: 'icon-72.png',              size: 72   },
      { dest: 'icon-72@2x.png',           size: 144  },
      { dest: 'icon-76.png',              size: 76   },
      { dest: 'icon-76@2x.png',           size: 152  },
      { dest: 'icon-83.5@2x.png',         size: 167  },
      { dest: 'icon-1024.png',            size: 1024 },
      { dest: 'icon-small.png',           size: 29   },
      { dest: 'icon-small@2x.png',        size: 58   },
      { dest: 'icon-small@3x.png',        size: 87   },
      { dest: 'icon.png',                 size: 57   },
      { dest: 'icon@2x.png',              size: 114  },
      { dest: 'AppIcon24x24@2x.png',      size: 48   },
      { dest: 'AppIcon27.5x27.5@2x.png',  size: 55   },
      { dest: 'AppIcon29x29@2x.png',      size: 58   },
      { dest: 'AppIcon29x29@3x.png',      size: 87   },
      { dest: 'AppIcon40x40@2x.png',      size: 80   },
      { dest: 'AppIcon44x44@2x.png',      size: 88   },
      { dest: 'AppIcon86x86@2x.png',      size: 172  },
      { dest: 'AppIcon98x98@2x.png',      size: 196  }
    ]
  });
  platforms.push({
    name : 'android',
